...
{
	//-------------------------------------------------------------------------
	public class TeleportPoint_Hacked : TeleportMarkerBase
	{
		...
		public Color teleportLockedColor;
	...
	public class TeleportPoint_HackedEditor : Editor
	{
		//-------------------------------------------------
		void OnEnable()
		{
